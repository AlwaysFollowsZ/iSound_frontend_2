        ...
        <n-grid>
            ...
            <n-gi :span="4"> 
                <div class="list-cover">
                    <n-image class="list-cover-img" src="/src/assets/default-admin.jpg"/>
                </div>
                <div style="margin: 30px 0px 20px 0px">
                    <n-breadcrumb>
                        <n-breadcrumb-item style="font-size: 25px;">
                        <n-icon :component="MusicalNotesOutline" size="30"/> 歌曲列表</n-breadcrumb-item>
                    </n-breadcrumb>
                </div>
            </n-gi>
            <n-gi :span="1"></n-gi>
            <n-gi :span="11" class="list-information">
                ...
                <n-grid :y-gap="10" :cols="1" style="width: 671px; height: 256px;">
                    <n-gi style="height: 50px;">
                        <n-grid>
                        <n-gi :span="21">
                            <div style="font-size:xx-large; height: 50px">{{ this.listName }}</div>
                        </n-gi>
                        <n-gi :span="3">
                    ...
                    <n-gi>
                        <div>
                           <a v-if="tags.length == 0" @click="editList">添加标签</a> 
                           <n-tag v-else v-for="(tag, i) in tags" :key="i" class="tags">#{{ tag }}</n-tag>
                        </div>
                    </n-gi>
                    <n-gi>
                        <div>歌曲数：{{ songNum }}</div>
                    ...
                    <n-gi>
                        ...
                        <n-button :focusable="false" @click="shareList" class="share-button">
                            <n-icon><OpenOutline/></n-icon>
                            分享歌单
                        </n-button>
                        <n-button :focusable="false" @click="complainList">
                ...
                <n-grid>
                    <n-gi :span="8">
                        ...
                        <div class="upload-list-cover" @click="uploadFile">
                            <n-upload class="upload-list-cover-image"
                            list-type="image-card"
                            accept="image/*"
                            max="1"
                            @preview="handlePreview" style="max-width: 200px">
