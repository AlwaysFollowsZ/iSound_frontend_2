                            ...
                            <n-gi>
                                <div style="font-size: larger">
                                    ...
                                    <div class="translationSwitch">
                                        <n-switch :rail-style="railStyle" v-if="hasTranslation"
                                            v-model:value="showTranslation" size="small" :round="false" @click="scroll">
                ...
                <div>
                    <n-collapse>
                        <n-collapse-item>
                            ...
                            <div>
                                <n-input style="margin-bottom: 15px" maxlength="200" show-count placeholder="我的评论"
                                    type="textarea" v-model:value="value" :style="{ '--n-border-radius': `10px` }"
                                    :autosize="{
                                        minRows: 6,
                                        maxRows: 6,
                                    }" />
                            ...
                            <div v-for="(comment_2nd, idx) in comment.comment_set" :key="idx">
                                <a-comment>
                                    ...
                                    <div v-if="this.edit2ndComment && this.edit2ndCommentId == comment_2nd.id">
                                        <div>
                                            <n-input style="margin-bottom: 15px" maxlength="200" show-count
                                                placeholder="我的评论" type="textarea" v-model:value="value"
                                                :style="{ '--n-border-radius': `10px` }" :autosize="{
                                                    minRows: 6,
                                                    maxRows: 6,
                                                }" />
                                            <div class="my-comment-button">
                                                <n-button class="send-button" strong secondary type="tertiary"
                                                    @click="send2ndComment">
                                                    发送
                                                </n-button>
                                                <n-button class="clean-button-2nd" strong secondary type="tertiary"
                                                    @click="cleanComment">
                                                    清空
                                                </n-button>
                                            </div>
    ...
    <n-modal :z-index="10" v-model:show="showCollections">
        <div :style="{
            ...
            <div :style="{
                ...
                'color': getRGBString(fontColorString, 1),
                'margin-top': '20px',
                'border-radius': '50px',
