                            ...
                            <n-grid>
                                ...
                                <n-gi :span="18">
                                    ...
                                    <div class="body-item-file-input">
                                        ...
                                        <input type="file" accept="audio/*" ref="songFileInput" @change="handleSongSrcFileChange" style="display: none"/>
                                    </div>
                                </n-gi>
                                <n-gi :span="3"></n-gi>
                            </n-grid>
                            ...
                            <n-grid>
                                ...
                                <n-gi :span="18">
                                    ...
                                    <div class="body-item-file-input">
                                        ...
                                        <input type="file" accept="application/octet-stream" ref="songLyricInput" @change="handleSongLyricFileChange" style="display: none"/>
                                    </div>
                                </n-gi>
                                <n-gi :span="3"></n-gi>
                            </n-grid>
