      ...
      <div class="title-container">
        <div style="margin-bottom: 30px">
          <n-grid>
            <n-gi :span="2"></n-gi>
            <n-gi :span="20">
              <div class="upload-card-title" :style="{ color: fontColorString }">
                上传歌曲：编织你的音乐篇章
              </div>
            </n-gi>
            <n-gi :span="2">
                ...
                <n-gi :span="18">
                  ...
                  <div class="body-item-file-input">
                    ...
                    <input
                      ...
                      accept="audio/*"
                      ref="songFileInput"
                      @change="handleSongSrcFileChange"
                      style="display: none"
                    />
                  </div>
                </n-gi>
                ...
                <n-gi :span="18">
                  ...
                  <div class="body-item-file-input">
                    ...
                    <input
                      type="file"
                      ref="songLyricInput"
                      @change="handleSongLyricFileChange"
                      style="display: none"
                    />
                  </div>
                </n-gi>
...
export default {
  ...
  methods: {
    ...
    handleUpdateValue(value, option) {
      ...
      let op = this.options.filter(function (v) {
