                        ...
                        <div class="body-item">
                            <n-grid>
                                ...
                                <n-gi :span="18">
                                    ...
                                    <n-input type="text" :placeholder="recordNum" :value="recordNum"
                                        @input="recordNum = $event" :style="{
                                            '--n-color': this.colorMode === 'white' ? 'white' : 'rgb(72,72,72)',
                                            '--n-color-focus':
                                                this.colorMode === 'white' ? 'white' : 'rgb(100,100,100)',
                                            '--n-text-color': this.colorMode === 'white' ? 'black' : 'white',
                        ...
                        <div class="body-item">
                            <n-grid>
                                ...
                                <n-gi :span="18">
                                    ...
                                    <n-input type="textarea" size="small" :placeholder="bio" :value="bio"
                                        @input="bio = $event" :style="{
                                            '--n-color': this.colorMode === 'white' ? 'white' : 'rgb(72,72,72)',
                                            '--n-color-focus':
                                                this.colorMode === 'white' ? 'white' : 'rgb(100,100,100)',
                                            '--n-text-color': this.colorMode === 'white' ? 'black' : 'white',
